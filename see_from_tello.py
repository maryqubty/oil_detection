        ...
        while True:
            ...
            while(cap.isOpened()):
                ...
                if not ret:
                    ...
                    break
                if count%5 ==0:
                    cv2.imwrite("/home/jeryes/Desktop/zig_zag/frame%d.jpg" % count, frame)
                #cv2.imwrite("/home/jeryes/Desktop/zig_zag/image%d.jpg" % count, frame)
                ret, jpeg = cv2.imencode('.jpg', frame)

                #img1 = cv2.imread(jpeg)
